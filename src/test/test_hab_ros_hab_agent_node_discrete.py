...
class HabROSHabAgentNodeDiscreteCase(unittest.TestCase):
    r"""
...
def main():
    rostest.rosrun(PACKAGE_NAME, "tests_hab_ros_hab_agent_node_discrete", HabROSHabAgentNodeDiscreteCase)
